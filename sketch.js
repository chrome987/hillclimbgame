...
function setup() {
    window.canvas = createCanvas(windowWidth, windowHeight); // Заменяем фиксированный размер на динамический
    canvas.parent("canvas-container");
    frameRate(30);
    
    headSprite = loadImage("Pics/NoneMust.png");
...
function windowResized() {
    resizeCanvas(windowWidth, windowHeight); // При изменении размера окна обновляем размер холста
}
