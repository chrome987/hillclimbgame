class Car {
    constructor(x, y) {
        ...
        this.wheels.push(new Wheel(x - this.chassisWidth / 1.8 + this.chassisWidth  * 0.2, y + this.chassisHeight / 2 + this.wheelSize / 4, this.wheelSize, this.chassisBody));
        this.wheels.push(new Wheel(x + this.chassisWidth / 1.8 - this.wheelSize * 0.2, y + this.chassisHeight / 2 + this.wheelSize / 4, this.wheelSize, this.chassisBody));
    ...
    show() {
        ...
        // Переносим отрисовку колёс в конец, чтобы они были поверх
